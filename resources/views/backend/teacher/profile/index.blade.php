...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Teacher Profile</div>
            <div class="ps-3">
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    @include('backend.teacher.profile.sidebar')
                            ...
                            <form action="{{ route('teacher.profile.store') }}" method="POST"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea type="text" name="experience" class="form-control">{{ auth()->user()->experience }}</textarea>
                                        </div>
                                    </div>
