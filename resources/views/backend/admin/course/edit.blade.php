            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('admin.course.update', $course->id) }}"
                            ...
                            <div class="col-md-6">
                                <label for="instructor_id" class="form-label">Select Teacher</label>
                                <select class="form-select" name="instructor_id" id="instructor_id" required>
                                    ...
                                    @foreach ($all_teachers as $teacher)
                                        <option value="{{ $teacher->id }}"
                                            {{ $teacher->id == $course->instructor_id ? 'selected' : '' }}>
