            ...
            <div class="col-lg-9">
                <div class="category-content-wrap">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">Kategori Jurusan</h2>
                    ...
                    <div class="col-lg-4 responsive-column-half">
                        <div class="category-item">
                            <img class="cat__img lazy" src="{{ asset($item->image) }}"
                                data-src={{ asset($item->image ?? 'frontend/images/img1.jpg') }} alt="Category image"
                                width="370" height="246">
                            <div class="category-content">
                                <div class="category-inner">
                                    <h3 class="cat__title"><a href="#">{{ $item->name }}</a></h3>
                                    <p class="cat__meta">{{ $item->subcategory_count }} Jurusan</p>
