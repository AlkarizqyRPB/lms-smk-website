        ...
        <div class="col-lg-8 mr-auto">
            <div class="breadcrumb-content">
                ...
                <p class="pt-2 pb-1">Created by <a href="teacher-detail.html"
                        class="text-color hover-underline">{{ $course['user']['username'] }}</a></p>
                <div class="d-flex flex-wrap align-items-center">
                    <p class="pr-3 d-flex align-items-center">
                        ...
                        Last updated {{ \Carbon\Carbon::parse($course->updated_at)->format('F Y') }}
                        {{-- tambahkan d kecil jika ingin ada tanggal atau hari --}}
                    </p>
                    {{-- <p class="pr-3 d-flex align-items-center">
                        <svg class="svg-icon-color-gray mr-1" width="16px" viewBox="0 0 24 24">
                            <path
