        ...
        <div class="container">
            <div class="related-course-wrap">
                <h3 class="fs-28 font-weight-semi-bold pb-35px">More Courses by <a href="#"
                        class="text-color hover-underline">{{ $course->user->username }}</a></h3>
                <div class="view-more-carousel-2 owl-action-styled">

                    @forelse ($more_course_teacher as $course)
                        <div class="card card-item">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><a href="">
                                        {{ \Illuminate\Support\Str::limit($course->course_name, 50) }}</a></h5>
                                <p class="card-text"><a href="teacher-detail.html">{{ $course['user']['username'] }}</a>
                                </p>
